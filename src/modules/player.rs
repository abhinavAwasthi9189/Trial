...
const MOVE_SPEED: f32 = 140.0;// pixel per second
const ANIM_DT: f32 = 0.1;//this tells the seconds perframe
...
//this is the time it takes to do, a sprite change.
...
//so a entity now can have a timer Component.
